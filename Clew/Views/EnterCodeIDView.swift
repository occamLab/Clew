...
class EnterCodeID: UIViewController, UITextFieldDelegate {
    ...
    var enterCodeIDButton: UIButton!
    ...
    override func viewDidAppear(_ animated: Bool){
        ...
        enterCodeIDButton.titleLabel?.font = UIFont.preferredFont(forTextStyle: .largeTitle)
    }
    ...
    override func viewDidLoad() {
        ...
        enterCodeIDButton = UIButton(type: .custom)
        enterCodeIDButton.layer.cornerRadius = 0.5 * enterCodeIDButton.bounds.size.width
        enterCodeIDButton.clipsToBounds = true
        enterCodeIDButton.translatesAutoresizingMaskIntoConstraints = false
        enterCodeIDButton.widthAnchor.constraint(equalToConstant: UIScreen.main.bounds.size.width / 1.1).isActive = true
        enterCodeIDButton.heightAnchor.constraint(equalToConstant: UIScreen.main.bounds.size.width / 2.5).isActive = true
        enterCodeIDButton.setBackgroundImage(UIImage(named: "WhiteButtonBackground"), for: .normal)
        enterCodeIDButton.imageView?.contentMode = .scaleAspectFit
        enterCodeIDButton.setTitle(NSLocalizedString("saveACodeIDButtonText", comment: "This is the text which appears on the save a code ID button."),for: .normal)
        enterCodeIDButton.setTitleColor(.black, for: .normal)
        enterCodeIDButton.titleLabel?.font = UIFont(name: "HelveticaNeue-Bold", size: 35)!
        enterCodeIDButton.accessibilityLabel = NSLocalizedString("saveACodeIDButtonAccessibilityLabel", comment: "A button that allows the user to save a code ID to the route they just recorded.")
        enterCodeIDButton.titleLabel?.textAlignment = .center
        enterCodeIDButton.titleLabel?.numberOfLines = 0
        enterCodeIDButton.titleLabel?.lineBreakMode = .byWordWrapping
        enterCodeIDButton.titleLabel?.font = UIFont.preferredFont(forTextStyle: .largeTitle)
        enterCodeIDButton.titleEdgeInsets.top = 0
        enterCodeIDButton.titleEdgeInsets.left = 5
        enterCodeIDButton.titleEdgeInsets.bottom = 0
        enterCodeIDButton.titleEdgeInsets.right = 5
        ...
        stackView.addArrangedSubview(enterCodeIDButton)
        ...
        enterCodeIDButton.addTarget(parent,
                                  action: #selector(ViewController.enterCodeIDButtonPressed),
                           for: .touchUpInside)
    }
