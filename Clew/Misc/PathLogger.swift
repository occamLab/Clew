...
///         dico:the dictonary the contains the conditons and  count
    ...
    func logSettings(siriShortcutTypeNameDictionary: [String:String]!, siriShortcutNameTypeDictionary: [String:String]!, defaultUnit: Int, defaultColor: Int, soundFeedback: Bool, voiceFeedback: Bool, hapticFeedback: Bool, sendLogs: Bool, timerLength: Int,  currentRoute: String, adjustOffset: Bool, currentCondition: String, experimentRouteFlag: Bool,experimentConditonsDico: [String: Any]!,conditionsDico: [String : Any]!, siriShortcutDisplayList: [String], siriShortcutsNameTypeDico: [String: Any]!, siriShortcutsTypeNameDico : [String: Any]!) {
        settingsHistory.append((Date(), ["siriShortcutTypeNameDictionary": siriShortcutTypeNameDictionary,"defaultUnit": defaultUnit, "defaultColor": defaultColor, "soundFeedback": soundFeedback, "voiceFeedback": voiceFeedback, "hapticFeedback": hapticFeedback, "sendLogs": sendLogs, "timerLength": timerLength, "adjustOffset": adjustOffset,"currentCondition":currentCondition,"experimentRouteFlag": experimentRouteFlag, "conditionsDico": conditionsDico,"experimentConditonsDico": experimentConditonsDico, "currentRoute":currentRoute, "siriShortcutDisplayList": siriShortcutDisplayList,"siriShortcutNameTypeDictionary": siriShortcutNameTypeDictionary, "siriShortcutsNameTypeDico":siriShortcutsNameTypeDico, "siriShortcutsTypeNameDico": siriShortcutsTypeNameDico]))
    }
